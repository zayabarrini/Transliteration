...
custom_a2en_table = {
    # Arabic Letters
    'ا': 'a', 'أ': 'a', 'إ': 'i', 'آ': 'aa', 'ء': "'",  # Hamza and Alif variations
    ...
    'ِ': 'i',  # Kasra
    'ْ': '',   # Sukun (no vowel)
    'ّ': '',   # Shadda (doubled consonant, handled separately)
    ...
    'آ': 'aa',   # Alif with Madda

    # Numbers (Arabic to Latin)
    '٠': '0', '١': '1', '٢': '2', '٣': '3', '٤': '4',
    '٥': '5', '٦': '6', '٧': '7', '٨': '8', '٩': '9',
