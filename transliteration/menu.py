...
""")
    ...
    if choice == "1":
        ...
        target_languages = input("Enter target languages (comma-separated, e.g., 'de,zh-ch'): ").strip().split(',')
...
""")
    ...
    if choice == "1":
        ...
        epub_folder = input("(Optional) Enter EPUB folder path for context (leave blank if none): ").strip()
        ...
        process_folder(html_folder, target_language, enable_transliteration, epub_folder if epub_folder else None)
        ...
        process_file(input_file, target_language, enable_transliteration, epub_folder if epub_folder else None)
